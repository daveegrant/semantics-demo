(function () {
  ...
  function mlD3Graph(mlRest) {
    return {
      ...
      link: function(scope, iElement, iAttrs, ctrl) {
        //
        // Sample URI - /data/router/USA-NYC-B-3-5-0.json
        //
        // rootcauseanalysis expects it to be:
        //    router/USA-NYC-B-3-5-0
        //
  ...
  function mlD3GraphController($scope, mlRest, $location) {
    ...
    function initGraph() {
      ...
      // var glinks = svgg.append("svg:g").selectAll("g.link");
      // console.log(glinks);
      // var link = glinks.data(force.links())
      //   .enter().append('g')
      //     .attr("class", function(d) { return "link bob"; })
      //     .attr("marker-end", function(d) { return "url(#licensing)"; });
      ...
      //   .attr("marker-end", function(d) { return "url(marker#licensing)"; });
      ...
      var linkPath = link.append("svg:path")
        .attr("class", function(d) { return "link licensing" })
        .attr("marker-mid", function(d) { return "url(" + absUrl + "#licensing)"; })
        .attr("marker-end", function(d) { return "url(" + absUrl + "#licensing)"; });
